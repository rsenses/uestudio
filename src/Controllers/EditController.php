...
class EditController
{
    ...
    public static function importantAction($id)
    {
        ...
        if ($video->section !== 'loquehayquever' && $video->section !== 'laprevia' && $video->section !== 'yodonabeautybrandsplace' && $video->section !== 'unpaseoporelprado' && $video->section !== 'feliziudad' && $video->section !== 'laporteriavertical') {
